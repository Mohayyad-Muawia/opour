      ...
      <div className="contact page">
        <div className="container">
          <div className="text">
            ...
            <div className="socials">
              ...
              <div className="links">
                ...
                <a className="card" href="https://www.facebook.com/opour.sd" target="_blank" rel="noopener noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M240 363.3L240 576L356 576L356 363.3L442.5 363.3L460.5 265.5L356 265.5L356 230.9C356 179.2 376.3 159.4 428.7 159.4C445 159.4 458.1 159.8 465.7 160.6L465.7 71.9C451.4 68 416.4 64 396.2 64C289.3 64 240 114.5 240 223.4L240 265.5L174 265.5L174 363.3L240 363.3z" /></svg>                </a>
                <a className="card" href="https://www.x.com/opour.sd" target="_blank" rel="noopener noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M453.2 112L523.8 112L369.6 288.2L551 528L409 528L297.7 382.6L170.5 528L99.8 528L264.7 339.5L90.8 112L236.4 112L336.9 244.9L453.2 112zM428.4 485.8L467.5 485.8L215.1 152L173.1 152L428.4 485.8z" /></svg>
                </a>
                <a className="card" href="https://www.linkedin.com/company/opour" target="_blank" rel="noopener noreferrer">
          ...
          <form action="" className="card">
            ...
            <button type="submit" className="submit btn primary">{t("form.submit")}</button>
          </form>
        </div>
      </div>
    </>
